      ...
      <div class="container">
        <div class="columns pd is-desktop">
          ...
          <div class="column is-one-third-desktop">
            <p class="title"><strong>A fancy header for a fancy company.</strong></p>
          </div>
          <div class="column">
        ...
        <div class="column">
          <div class="card">
            <div class="card-content">
              <p class="title">"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore."</p>
              <p class="subtitle">- Saad Ulde</p>
            </div>
          </div>
        </div>
        <div class="column">
